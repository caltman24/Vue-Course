<template>
  ...
  >
    ...
    >
      ...
      <div
        class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full modal-size"
      >
        ...
        <div class="py-4 text-left px-6">
          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a
                ...
                href="#"
                @click.prevent="selectedTab = 'login'"
                :class="{
            ...
            <li class="flex-auto text-center">
              <a
                class="block rounded py-3 px-4 transition"
                href="#"
                @click.prevent="selectedTab = 'register'"
                :class="{
                  'hover:text-white text-white bg-blue-600':
          ...
          <form v-show="selectedTab === 'login'">
            ...
            <button
              type="submit"
              class="block w-full bg-purple-600 text-white py-2 px-3 rounded transition hover:bg-purple-700 my-4"
            >
              Submit
            </button>
          </form>
  ...
  data() {
    return {
      ...
      schema: {
        ...
        age: "required|minValue:18|maxValue:150",
